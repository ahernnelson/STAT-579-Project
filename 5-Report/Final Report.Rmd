...
# source("..//3-Graphics//freq_dist.R") # gif animation for html render
...
all_data %>% 
    ...
    labs(title="Figure 1: PQI Frequency Distribution: 2017")
```
...
source("..//3-Graphs//percent_units_pqi.R")
```
...
### Rental Status and PQI

```{r more rent, fig.dim=c(11,6)}
source("..//3-Graphs//rent_share_pqi.R")
```
